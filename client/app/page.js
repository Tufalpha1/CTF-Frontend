...
import { Bug, SquareTerminal, Binary, FileDigit, Fingerprint, GlobeLock, Shield, Crown } from "lucide-react"
...
const Home = () => {
  ...
  return (
    <div className="py-8 mx-auto max-w-screen-2xl text-center lg:py-16 lg:px-12">
          ...
          >
            <div className="py-1">
              <MenuItem>
                <Link
                  href="/city"
                  className="block px-4 py-2 text-sm text-slate-100 data-[focus]:bg-gray-100 data-[focus]:text-gray-900"
                >
                  Islamabad
                </Link>
              </MenuItem>
      ...
      <div className="my-64">
        ...
        <div className="container max-w-5xl mt-12 grid grid-cols-1 gap-y-8 sm:grid-cols-2 lg:grid-cols-3 place-items-center sm:gap-y-8 mx-auto">
          <div className="btn"><Link href="#" className="flex flex-row gap-4 items-center justify-center mx-auto"><Bug /> PWN </Link></div>
          <div className="btn"><Link href="#" className="flex flex-row gap-4 items-center justify-center"><Binary /> REV </Link></div>
          <div className="btn"><Link href="#" className="flex flex-row gap-4 items-center justify-center"><SquareTerminal /> WEB </Link></div>
          <div className="btn"><Link href="#" className="flex flex-row gap-4 items-center justify-center"><FileDigit /> CRYPTO </Link></div>
          <div className="btn"><Link href="#" className="flex flex-row gap-4 items-center justify-center"><Fingerprint /> FORENSICS </Link></div>
          <div className="btn"><Link href="#" className="flex flex-row gap-4 items-center justify-center"><GlobeLock /> OSINT </Link></div>
          <div className="btn"><Link href="#" className="flex flex-row gap-4 items-center justify-center"><Shield /> BLUE TEAM </Link></div>
          <div className="btn"><Link href="#" className="flex flex-row gap-4 items-center justify-center"><Crown /> PWN 2 OWN </Link></div>
          <div className="btn"><Link href="#" className="flex flex-row gap-4 items-center justify-center"><Bug /> BUG BOUNTY </Link></div>
        </div>
      </div>
